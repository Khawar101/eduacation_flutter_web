...
class DataTables extends StatefulWidget {
  ...
  final name = "Olivia Rhye", email = "hello@oliviarhye.com", status, course ="UI Masterclass", enroll_date = "Jan4 ,2022";
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                CustomText(
                                    text: widget.name+" "+(index+1).toString(),
                                    size: 14,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.black),
                                Text(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    index%3==0?"Unenrolled":widget.status,
